...
export * from './domain/water/water.js'
...
export * from './application/queries/placement.js'
export * from './application/queries/network.js'
export * from './application/queries/progression.js'
export * from './application/scenarios.js'
